...
function App() {
    ...
    if (currentUser.role === "corporate") {
        ...
        homePage = <StoresNearMe corporate={corporate} currentUser={currentUser} setCorporate={setCorporate}/>
    }
        ...
        <Router>
            <div className={"pageLayout"}>
                ...
                <Routes>
                    ...
                    <Route path="/stores" element={<StoresNearMe corporate={corporate} currentUser={currentUser} setCorporate={setCorporate}/>}/>
